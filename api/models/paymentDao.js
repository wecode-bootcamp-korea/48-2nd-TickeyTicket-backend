...
const insertPaymentInformation = async(userId, productOptionId, paymentCode, qrcodeUrl, paymentTotalQuantity, paymentTotalPrice) => {
    try {
        await appDataSource.query(
            `INSERT INTO payment_information(
                ...
                payment_total_price)
            VALUES (?, ?, ?, ?, ?, ?);`,
            [userId, productOptionId, paymentCode, qrcodeUrl, paymentTotalQuantity, paymentTotalPrice]
        );
